...
console.log(hasDashboardAccess,"222")
  return (
    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Today's Profit" count="7008" percentage={30.5} extra="3000" />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Succesfull Order" count="20" percentage={27.4}  extra="10" />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
